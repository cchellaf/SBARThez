...
<p align="center">
  <img src="assets/newsumm_archi.drawio_page-0001.jpg" alt="SBARThez architecture" width="400"/>
</p>
...
git clone https://github.com/cchellaf/SBARThez.git

# 2. Move into the project folder
cd SBARThez

# 3. Create a conda env at a path you choose, with a Python version
conda create -p /path/to/envs/sbarthez python=3.10 -y

# 4. Activate it (with a prefix env you activate by path, not by name)
...
This will produce `*_embeddings.scp`, `*_tokens.scp`, and `*_ner.scp` (plus their `.ark` counterparts) for the chosen split, that will be saved in the folder `dataset/data`.
